...
def index(request, user_required=True, user_type_required=User.UserType.ACCOUNTSMANAGER):
...
def manageUser(request, userID, user_required=True, user_type_required=User.UserType.ACCOUNTSMANAGER):
...
def createUser(request, user_required=True, user_type_required=User.UserType.ACCOUNTSMANAGER):
